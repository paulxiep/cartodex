# Cartodex Individual Contributor License Agreement

Based on the Harmony Agreements 1.0 (CLA-I) template, adapted as a
*License Grant* (not Copyright Assignment) for the Cartodex project.

---

Thank you for your interest in contributing to Cartodex ("**We**" or "**Us**").
...
in [`CONTRIBUTING.md`](CONTRIBUTING.md). This is a legally binding
document, so please read it carefully before agreeing to it. The
...
not own the Copyright in the entire work of authorship, please follow the
guidelines in [`CONTRIBUTING.md`](CONTRIBUTING.md) for Submitting work
that includes content owned by others.
...
**"Material"** means the work of authorship which is made available by
...
**Note**: this clause is the relicense-enabling clause. It explicitly
permits Cartodex to relicense Your Contribution under terms different
from the license in effect when You Submitted, while preserving the
license that was in effect on the Submission Date as a floor.
...
[`CONTRIBUTING.md`](CONTRIBUTING.md) if You do not own the Copyright in
...
DATA, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL AND EXEMPLARY
...
IF THE DISCLAIMER AND DAMAGE WAIVER MENTIONED IN SECTION 4 AND SECTION
5 CANNOT BE GIVEN LEGAL EFFECT UNDER APPLICABLE LOCAL LAW, REVIEWING
...
7.2 This Agreement shall apply for the term of the copyright and
...
Section 2.3. Such termination must be made in writing.
...
shall be governed by the laws of **Singapore** excluding its private
...
apply notwithstanding any failure of essential purpose of this
...
**Us** (the Cartodex project, currently represented by):

- Name: Rachapong Chirarattananon
- Date: ____________________________
- Signature: ____________________________

---

*Adapted from the Harmony Agreements 1.0 CLA-I template
(http://harmonyagreements.org/). Modified to use the License Grant
variant exclusively (Harmony's "Copyright Assignment" path has been
removed).*
